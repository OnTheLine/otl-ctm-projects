...
jQuery(function() {
    ...
    jQuery(".sourceline").html("Sources: " + q.source);
    ...
    Highcharts.setOptions({
        //colors: ['#494B52', '#cc4545', '#F2784B', '#6C7A89']
                colors: ['rgb(228,26,28)','rgb(55,126,184)','rgb(77,175,74)','rgb(152,78,163)','rgb(255,127,0)','rgb(255,255,51)','rgb(166,86,40)','rgb(247,129,191)','rgb(153,153,153)', '#ffffff']
    ...
    if ($(window).width() < 550) {
     ...
     var chart = new Highcharts.Chart({
        ...
        tooltip: {
            ...
            formatter: function() {
                return "<div class='toolTipper'>" + this.key + " " + this.series.name + "</div><div class='tooltipbottom'>" + q.yPrefix + comma(this.y) + q.ySuffix + "</div>";
            },
            style: {
                fontFamily: "Lato, Arial",
                color: "#333",
    ...
    function shaper() {
        ...
        jQuery(mainContainer).css("height", leftover * 0.9 + "px");
    }
