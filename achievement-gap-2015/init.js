$(function() {
    ...
    function setRect(subject, race1, race2) {
        ...
        $(".rect").each(function() {
            ...
            console.log(data[place][obj1] + "," + data[place][obj2]);
            ...
            if (race1 == race2) {
                $(this).css("left", left + "%")
                    ...
                    .attr("id", "sorting" + Math.round(left * 10000))
                ...
                $(this).css("left", left + "%")
                    ...
                    //.css("opacity",width/30)
                    .attr("gap", cleanNum(Math.abs(data[place][obj1] - data[place][obj2])))
                    .attr("id", "sorting" + Math.round(width * 10000))
                    .attr("num1", data[place][obj1])
                    .attr("num2", data[place][obj2]);
        ...
        var widthsCounter = 3;
        for (i in allWidths) {
            $("#sorting" + allWidths[i]).css("top", (widthsCounter / 55) * 100 + "%").attr("rank", widthsCounter);
